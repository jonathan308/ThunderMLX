...
ssh -o BatchMode=yes -o ConnectTimeout=8 ${M3_PEER:-worker.local} 'pkill -TERM -f "run_with_watchdog|sharded_server|mlx-vlm064-env/bin/python" 2>/dev/null' 2>/dev/null
sleep 3
