...
def settings():
    ...
    for key in (
        ...
        "MLX_M3_THINKING_DEFAULT_TEMPERATURE",
        "MLX_M3_THINKING_DEFAULT_TOP_P",
        "MLX_M3_THINKING_DEFAULT_TOP_K",
        "MLX_M3_THINKING_DEFAULT_MIN_P",
        "MLX_M3_THINKING_DEFAULT_REPETITION_PENALTY",
        "MLX_M3_THINKING_ARTIFACT_TRANSITION",
        "MLX_M3_THINKING_ARTIFACT_TRANSITION_MIN_TOKENS",
        "MLX_M3_DECODE_REPETITION_GUARD_TOKENS",
...
def write_setting(key, value):
    ...
    allowed = {
        ...
        "MLX_M3_THINKING_DEFAULT_TEMPERATURE": r"[0-9]+(\\.[0-9]+)?",
        "MLX_M3_THINKING_DEFAULT_TOP_P": r"[0-9]+(\\.[0-9]+)?",
        "MLX_M3_THINKING_DEFAULT_TOP_K": r"[0-9]+",
        "MLX_M3_THINKING_DEFAULT_MIN_P": r"[0-9]+(\\.[0-9]+)?",
        "MLX_M3_THINKING_DEFAULT_REPETITION_PENALTY": r"[0-9]+(\\.[0-9]+)?",
        "MLX_M3_THINKING_ARTIFACT_TRANSITION": r"[01]",
        "MLX_M3_THINKING_ARTIFACT_TRANSITION_MIN_TOKENS": r"[0-9]+",
        "MLX_M3_DECODE_REPETITION_GUARD_TOKENS": r"[0-9]+",
